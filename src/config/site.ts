export const siteConfig = {
  ...
  resume:
    "https://drive.google.com/file/d/154QCzr82qr664OZjbxyFxpVnw0tOybqz/view?usp=sharing",
  medium: "https://medium.com/@jayraje",
  mediumRSS:
    "https://api.rss2json.com/v1/api.json?rss_url=https://medium.com/feed/@jayraje",
  ...
  learning: [
    {
      topic: "Linux Server Administration",
      detail:
        "Managing Ubuntu VPS, systemd services, users and file permissions",
    },
    {
      topic: "NGINX & Reverse Proxies",
      detail: "Virtual hosts, SSL termination, proxying Node/Next.js apps",
    },
    {
      topic: "DNS & Networking",
      detail: "A/CNAME records, TTL, how requests route end-to-end",
    },
    {
      topic: "Cloud Hosting & Deployment",
      detail:
        "Self-hosting on VPS, understanding what Railway/Render abstract away",
    },
    {
      topic: "Logging & Monitoring",
      detail:
        "Application logs, health checks, basic observability fundamentals",
    },
    {
      topic: "Containerization (Docker)",
      detail: "Dockerfiles, service composition, image layers",
    },
    {
      topic: "CI/CD Pipelines",
      detail: "Automated deploys, environment configs, build artifacts",
    },
    {
      topic: "Security Fundamentals",
      detail: "TLS/SSL, secrets management, ufw firewall, SSH hardening",
    },
  ],
} as const;
